...
export function LoginModal() {
  ...
  // Handle Phone input formatting (10 digits)
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    const res = await verifyOtp(phoneNumber, token, context, authModalReturnTo);
          ...
          >
            ...
            <div className="p-6 pt-2 pb-8">
              <AnimatePresence mode="wait">
                ...
                {/* 2. PHONE NUMBER INPUT STATE (CUSTOMER / VENDOR) */}
